Ext.define('CDI.ioc.DependencyProvider', {
    requires: ['CDI.log.Logger'],
    config: {
        identifier: null,
        /**
    ...
    constructor: function(config) {
        ...
        if (this.getClassName() != null) {
            ...
            if (!(classDefinition != null)) {
                CDI.Logger.warn("Synchronously loading '" + (this.getClassName()) + "'; consider adding Ext.require('" + (this.getClassName()) + "') above Ext.onReady.");
    ...
    resolve: function(targetInstance) {
        ...
        CDI.Logger.log("Resolving '" + (this.getIdentifier()) + "'.");
        if (this.getValue() !== void 0) {
            return this.getValue();
        }
        instance = null;
        if (this.getFn() != null) {
            CDI.Logger.log("Executing factory function.");
            instance = this.getFn().call(null, targetInstance);
        } else if (this.getClassName() != null) {
            if (Ext.ClassManager.get(this.getClassName()).singleton) {
                CDI.Logger.log("Using existing singleton instance of '" + (this.getClassName()) + "'.");
                instance = Ext.ClassManager.get(this.getClassName());
            } else {
                CDI.Logger.log("Creating instance of '" + (this.getClassName()) + "'.");
